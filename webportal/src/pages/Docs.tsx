        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-3">
            ...
            <StepTile n={3} title="Configure Endpoints">
              Enter this Web Portal URL (<code className="px-1.5 py-0.5 rounded bg-white/10">{typeof window !== 'undefined' ? window.location.origin : 'https://api.whizpoint.app'}</code>) as the Back Office URL, and paste the API Key generated in Step 1.
            </StepTile>
