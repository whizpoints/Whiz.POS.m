...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Josphat Mburu\\Documents\\codes\\Whiz_POS-master\\local-server\\dist-server\\prisma-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "93d1889262b03e41cd558cdead09b9cea9fb02c421560e9a4611346a2944d59d",
  "copyEngine": true
}
...
path.join(process.cwd(), "dist-server/prisma-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "dist-server/prisma-client/schema.prisma")
