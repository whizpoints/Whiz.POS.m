...
file_path = r'c:\Users\Josphat Mburu\Documents\codes\Whiz_POS-master\webportal\src\pages\Settings.tsx'
with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Replace Settings component to include fetchProfile state
settings_comp = '''export default function Settings() {
...
content = re.sub(r'export default function Settings\(\) \{.*?(?=\/\* \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- Security \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- \*\/)', settings_comp + '\n\n', content, flags=re.DOTALL)


# SecurityPanel replacement
security_comp = '''function SecurityPanel({ profile, fetchProfile }: any) {
...
content = re.sub(r'function SecurityPanel\(\) \{.*?(?=\/\* \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- Payments \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- \*\/)', security_comp + '\n\n', content, flags=re.DOTALL)

# Also fix ApiKeyRow signature
content = content.replace('function ApiKeyRow({ label, key, status, badge }: { label: string; key: string; status: \'live\' | \'test\' | \'revoked\'; badge: string }) {', 'function ApiKeyRow({ label, keyStr, status, badge }: { label: string; keyStr: string; status: \'live\' | \'test\' | \'revoked\'; badge: string }) {')
content = content.replace('<CopyField value={key} />', '<CopyField value={keyStr} />')


# ETimsPanel
etims_comp = '''function ETimsPanel({ profile, onSave }: any) {
...
content = re.sub(r'function ETimsPanel\(\) \{.*?(?=\/\* \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- Profile \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- \*\/)', etims_comp + '\n\n', content, flags=re.DOTALL)


# ProfilePanel
profile_comp = '''function ProfilePanel({ profile, onSave }: any) {
...
content = re.sub(r'function ProfilePanel\(\) \{.*?(?=\/\* \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- Notifications \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- \*\/)', profile_comp + '\n\n', content, flags=re.DOTALL)


# NotificationsPanel
notifications_comp = '''function NotificationsPanel({ profile, onSave }: any) {
  const [formData, setFormData] = useState({
...
content = re.sub(r'function NotificationsPanel\(\) \{.*?(?=\/\* \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- Shared primitives \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\- \*\/)', notifications_comp + '\n\n', content, flags=re.DOTALL)
